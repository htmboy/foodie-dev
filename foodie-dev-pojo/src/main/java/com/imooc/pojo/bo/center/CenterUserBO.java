...
public class CenterUserBO {
    ...
    @ApiModelProperty(value = "手机号", name = "mobile", example = "15899555540", required = false)
    private String mobile;

    @Email
    @ApiModelProperty(value = "邮箱地址", name = "email", example = "htmboy8@msn.com", required = false)
    ...
    @ApiModelProperty(value = "生日", name = "birthday", example = "1988-01-19", required = false)
